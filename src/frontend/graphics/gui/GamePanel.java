...
/**
 * Panel al que se le pueden agregar, eliminar y mover imágenes. Al mover una imagen, esta se desplaza hasta las coordenadas destino indicadas. La velocidad con la que se mueven las imágenes puede ser parametrizada. <p> Tener en cuenta que el orden en que las imágenes son pintadas coincide con el orden en que las mismas son agregadas al panel. </p>
 */
public class GamePanel extends JPanel {
	 ...
	 * <p>
	 * La invocación a este método es bloqueante hasta que la imagen llega a las coordenadas destino.
	 * </p>
	 * 
	 * @param sprite Imagen que se desea mover.
	 * @param position Nueva posición a donde se debe mover el sprite.
	 */
	...
	/**
	 * Mueve una imagen hacia una nueva posición.
	 * 
	 * @param sprite Imagen que se desea mover.
	 * @param position Nueva posición a donde se debe mover el sprite.
	 */
	...
	/**
	 * Modifica la cantidad de pixels que las imágenes deben avanzar en cada paso cuando son desplazados.
	 */
